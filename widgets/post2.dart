...
class Post2 extends StatefulWidget {
  ...
  const Post2({Key key, this.postId, this.ownerId, this.username, this.location, this.description, this.mediaUrl, this.likeCount,this.likes}) : super(key: key);
        ...
        Row(
          children: [
            Container(
              ...
              child: Text(widget.likeCount.toString(),style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold ),),
            ),
          ],
        ),
        Row(
          children: [
            Container(
              margin: EdgeInsets.only(left: 20.0),
              child: Text(widget.username,style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold ),),
            ),
            Expanded(
